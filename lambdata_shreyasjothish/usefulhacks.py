...
class UsefulHacks:
    ...
    def help(self):
        """
        This function returns list of function names with useful coding \
        hacks snippets.
        """
        print('Here the code snippets assumes pandas and numpy are imported \
        as given below')
        ...
        print('unlimited_columns_display: Setting unlimited columns for \
        display')
        print('unlimited_rows_display: Setting unlimited rows for display')
        print('select_numeric_columns: Selecting only numerical columns in \
        DataFrame')
        print('display_data_instances: Display the number of instances of \
    ...
    def display_data_instances(self):
        """
        Code snippet for displaying the number of instances of data within a \
        column
        """
